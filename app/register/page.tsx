        ...
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <div className="rounded-2xl border border-border bg-white p-6 shadow-sm">
            <form onSubmit={handleSubmit} className="space-y-4">
              {/* Personal Info */}
              <div>
                <p className="mb-2.5 text-[11px] font-semibold uppercase tracking-wider text-gray-400">Personal Information</p>
              ...
              {/* Account Info */}
              <div>
                <p className="mb-2.5 text-[11px] font-semibold uppercase tracking-wider text-gray-400">Account Information</p>
                <div className="space-y-3">
                  <div>
              ...
              {/* Security */}
              <div>
                <p className="mb-2.5 text-[11px] font-semibold uppercase tracking-wider text-gray-400">Security</p>
                <div className="space-y-3">
                  <div>
